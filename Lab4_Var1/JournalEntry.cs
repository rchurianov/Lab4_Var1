...
namespace Lab4_Var1
{
    public class JournalEntry
    {
         ...
         */
        public JournalEntry(string collection_name, Action change_type, string property_name, string key)
        {
            this.ChangedCollectionName = collection_name;
            this.ChangeType = change_type;
            this.StudentPropertyName = property_name;
            this.ChangedObjectKey = key;
        }
        ...
        public string StudentPropertyName { get; set; }

        public string ChangedObjectKey { get; set; }
